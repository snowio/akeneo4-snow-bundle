Akeneo 4 Snow Bundle
=====================================

This is a custom Akeneo 4 bundle.
...
To install this bundle on a Akeneo 4 instance, run the following:

`composer require snowio/akeneo4-snow-bundle`
